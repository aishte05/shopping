...
?>
                                            ...
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo "Php"." ".$row['productPrice']; ?>.00</span>
                                            </td>
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo "Php"." ".$row['shippingCharge']; ?>.00</span>
                                            </td>

                                            <td class="cart-product-grand-total"><span
                                                    class="cart-grand-total-price"><?php echo "Php ".($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span>
                                            </td>
                                        </tr>
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <div class="cart-grand-total">
                                            Total: <span class="inner-left-md">Php
