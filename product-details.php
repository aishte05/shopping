                                ...
                                <div class="product-social-link m-t-20 text-right">
                                    ...
                                    <div class="social-icons">
                                        <ul class="list-inline">
                                            <li><a class="fa fa-facebook" href="http://facebook.com/razzel00"></a></li>
                                            <li><a class="fa fa-twitter" href="https://twitter.com/Aishte05"></a></li>
                                            <li><a class="fa fa-instagram" href="https://www.instagram.com/aishte05/"></a></li>
                                            <li><a class="fa fa-youtube" href="https://www.youtube.com/"></a></li>
                                            <li><a class="fa fa-pinterest" href="https://www.pinterest.ph/jamesrazzel/"></a></li>
                                        </ul>
                                    </div>
                                </div>
...
while($rw=mysqli_fetch_array($qry))
{
			...
			?>
                ...
                <div class="item item-carousel">
                    ...
                    < </div> <?php } ?> </div> </section> </div> <div class="clearfix">
